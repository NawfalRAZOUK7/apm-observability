...
\begin{itemize}
    ...
    \item Appliquer une politique de rétention sur l’hypertable brute (la compression colonnaire n’est pas utilisée : incompatible avec le Row-Level Security multi-locataire ; cf. chapitre~\ref{sec:avance}).
