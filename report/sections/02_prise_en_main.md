...
Lien projet:
- Runbook complet: `report/PRISE_EN_MAIN.md`
...
![Admin Django - ApiRequest](../../docs/images/django-admin-apirequest.png)

Grafana datasources (TimescaleDB + Prometheus):
![Grafana datasources](../../docs/images/grafana-datasources.png)
