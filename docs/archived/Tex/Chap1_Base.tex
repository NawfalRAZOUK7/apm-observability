...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/timescaledb.png}
    \caption{Page d'accueil du site de TimescaleDB}
\end{figure}

\subsection{Use Case de la base}

TimescaleDB est utilisée par de nombreuses entreprises à l’échelle mondiale, notamment dans les domaines du monitoring, de l’IoT et de la finance.
...
\begin{itemize}
    \item une compression columnaire très efficace (jusqu’à 90–95 \%)
