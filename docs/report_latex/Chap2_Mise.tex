...
\begin{itemize}
    ...
    \item Appliquer des politiques de compression colonnaire et de rétention sur l’hypertable brute (cf. chapitre~\ref{sec:avance} pour le cycle de vie des données).
